 ...
 */
expect abstract class DescopeOAuth {
     ...
     */
    abstract suspend fun signUp(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null): String

    /** @see signUp */
    abstract fun signUp(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null, callback: (Result<String>) -> Unit)
     ...
     * @return a URL that starts the OAuth redirect chain
     */
    abstract suspend fun signIn(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null): String

    /** @see signIn */
    abstract fun signIn(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null, callback: (Result<String>) -> Unit)
     ...
     * @return a URL that starts the OAuth redirect chain
     */
    abstract suspend fun signUpOrIn(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null): String

    /** @see signUpOrIn */
    abstract fun signUpOrIn(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null, callback: (Result<String>) -> Unit)
    ...
    abstract suspend fun start(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null): String

    /** @see start */
    @Deprecated(message = "Use signUpOrIn instead", replaceWith = ReplaceWith("signUpOrIn(provider, redirectUrl, options, callback)"))
    abstract fun start(provider: OAuthProvider, redirectUrl: String? = null, options: List<SignInOptions>? = null, callback: (Result<String>) -> Unit)
     ...
     * @return an [AuthenticationResponse] upon successful verification.
     */
    abstract suspend fun exchange(code: String): AuthenticationResponse

    /** @see exchange */
    abstract fun exchange(code: String, callback: (Result<AuthenticationResponse>) -> Unit)
     ...
     */
    abstract suspend fun native(provider: OAuthProvider, options: List<SignInOptions>? = null): AuthenticationResponse

    /** @see native */
    abstract fun native(provider: OAuthProvider, options: List<SignInOptions>? = null, callback: (Result<AuthenticationResponse>) -> Unit)
}
 ...
 */
expect abstract class DescopePasskey() {
    /**
    ...
    abstract suspend fun signUp(loginId: String, details: SignUpDetails? = null): AuthenticationResponse
     ...
     */
    @RequiresApi(value = 28)
    abstract suspend fun signIn(loginId: String, options: List<SignInOptions>? = null): AuthenticationResponse
     ...
     */
    @RequiresApi(value = 28)
    abstract suspend fun signUpOrIn(loginId: String, options: List<SignInOptions>? = null): AuthenticationResponse
     ...
     */
    @RequiresApi(value = 28)
    abstract suspend fun add(loginId: String, refreshJwt: String)
}
...
interface DescopeFlow {
    ...
    val currentRunner: DescopeFlowRunner?

    /**
     * Create a new [DescopeFlowRunner] that is able to run user authentication flows.
     *
     ...
     */
    fun create(flowUrl: String, deepLinkUrl: String, backupCustomScheme: String? = null): DescopeFlowRunner
...
expect abstract class DescopeFlowRunner() {
    ...
    /** @see start */
    abstract fun start(callback: (Result<Unit>) -> Unit)
     ...
     */
    abstract fun resume(incomingUriString: String)
     ...
     * @return an [AuthenticationResponse] upon successful verification.
     */
    abstract suspend fun exchange(incomingUri: Uri): AuthenticationResponse

    /** @see exchange */
    abstract fun exchange(incomingUri: Uri, callback: (Result<AuthenticationResponse>) -> Unit)
}

/**
 * Customize the flow's presentation by implementing the [DescopeFlowPresentation] interface.
 */
expect abstract class DescopeFlowPresentation()