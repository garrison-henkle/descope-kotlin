...
import com.descope.internal.others.isMainThread
...
class DescopeSdk(projectId: String, configure: DescopeConfig.() -> Unit) {
    ...
    init {
        ...
        sessionManager = initDefaultManager(config)
    }

    // Internal

    private fun initDefaultManager(config: DescopeConfig): DescopeSessionManager {
