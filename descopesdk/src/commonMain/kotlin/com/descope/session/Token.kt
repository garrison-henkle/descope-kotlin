...
import com.descope.internal.others.createDateStringFromEpochSec
...
internal class Token(
    ...
    override val isExpired: Boolean
        get() = expiresAt <= currentTimeMillis()
    ...
    override fun toString(): String {
        ...
        val date = createDateStringFromEpochSec(format = "yyyy-MM-dd HH:mm:ss", epochSec = expiresAt)
...
private fun decodeFragment(string: String): Map<String, Any> {
    ...
    try {
        val json = createJSONObject(data.decodeToString())
        return json.toMap()
    } catch (_: Exception) {
